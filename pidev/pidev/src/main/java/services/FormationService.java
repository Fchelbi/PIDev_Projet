...
public class FormationService implements CRUD<Formation> {
    ...
    public void insertOne(Formation formation) throws SQLException {
        ...
        PreparedStatement Fs = cnx.prepareStatement(req);
        Fs.setString(1, formation.getTitle());
        Fs.setString(2, formation.getDescription());
        Fs.setString(3, formation.getVideoUrl());
        Fs.setString(4, formation.getCategory());
